...
class UPAT_The_Ultimate_Password_Awareness_Toolkit:
    def __init__(self, top=None):
        ...
        self.Btn_Import_Delete = ttk.Button(self.TLabelframe2)
        self.Btn_Import_Delete.place(relx=0.87, rely=0.76, height=25, width=88)
        self.Btn_Import_Delete.configure(takefocus="")
        self.Btn_Import_Delete.configure(text='''Delete''')
        self.Btn_Import_Delete.bind('<Button-1>',lambda event:home_support.Btn_Import_Delete_Click())
        ...
        self.TNotebook1.tab(4, text="Mentalist",underline="-1",)
        ...
        self.Btn_Gen_Mentalist = ttk.Button(self.TNotebook1_pg4)
        self.Btn_Gen_Mentalist.place(relx=0.38, rely=0.28, height=50, width=248)
        self.Btn_Gen_Mentalist.configure(takefocus="")
        self.Btn_Gen_Mentalist.configure(text='''Launch the Mentalist''')
        self.Btn_Gen_Mentalist.bind('<Button-1>',lambda e: home_support.Btn_Gen_Mentalist())
...
?s - a single special character''')
        ...
        self.Txt_Attack_BF_Temp.place(x=295, y=46, height=18, width=29)
        ...
        self.Label72.place(relx=0.87, rely=0.47, height=34, width=34)
        ...
        self.Label75.place(relx=0.87, rely=0.07, height=34, width=34)
        ...
        self.TLabelframe32.place(x=15, y=401, height=55, width=380)
        ...
        self.TLabel57.place(relx=0.03, rely=0.27, height=16, width=137)
        ...
        self.Label73.place(relx=0.63, rely=0.05, height=34, width=34)
        ...
        self.Label76.configure(image=self._img69)
        ...
        self.Btn_Attack_BF_Help = ttk.Button(self.TLabelframe29)
        self.Btn_Attack_BF_Help.place(relx=0.93, rely=0.02, height=25, width=48)
        self.Btn_Attack_BF_Help.configure(takefocus="")
        self.Btn_Attack_BF_Help.configure(text='''Help?''')
        self.Btn_Attack_BF_Help.bind('<Button-1>',lambda event:home_support.Btn_Attack_BF_Help_Click())
        ...
        self.Label69.configure(image=self._img70)
        ...
        self.Label77.configure(image=self._img71)
        ...
        self._img72 = PhotoImage(file="delete.png")
        self.Label62.configure(image=self._img72)
        ...
        self._img73 = PhotoImage(file="clipboard.png")
        self.Label63.configure(image=self._img73)
        ...
        self._img74 = PhotoImage(file="info_small.png")
        self.Label80.configure(image=self._img74)
        ...
        self._img75 = PhotoImage(file="delete.png")
        self.Label78.configure(image=self._img75)
        ...
        self._img76 = PhotoImage(file="clipboard.png")
        self.Label79.configure(image=self._img76)
